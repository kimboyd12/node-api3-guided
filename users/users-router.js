...
router.get("/users", (req, res) => {
	...
	users.find(options)
		...
		.catch((error) => {
			// if next gets called with no parametes, then it moves on to the next piece of middleware
			// if it gets called WITH a parameter, it considers that param an error and moves on the error middleware
			next(error)
